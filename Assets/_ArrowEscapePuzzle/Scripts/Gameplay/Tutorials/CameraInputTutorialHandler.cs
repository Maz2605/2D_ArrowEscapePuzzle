...
{
    /// <summary>
    /// Handler cho các màn tutorial hướng dẫn điều khiển camera (Zoom, Pan, Reset).
    /// Có thể tái sử dụng cho bất kỳ level nào bằng cách gán handlerTypeName = "CameraInputTutorialHandler"
    /// trong TutorialConfigSO của level đó.
    /// </summary>
    public class CameraInputTutorialHandler : BaseTutorialHandler
    {
